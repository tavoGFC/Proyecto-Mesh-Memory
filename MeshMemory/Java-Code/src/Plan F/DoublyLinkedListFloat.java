...
public class DoublyLinkedListFloat{
	
	private DoublyNodeFloat head = null; //null node for the head of the list
	private DoublyNodeFloat tail = null; //null node for the tail of the list
	private String id;
	 ...
	 * @param pData
	 */
	public void insertAtBeginning(float tData){
		
		DoublyNodeFloat data = new DoublyNodeFloat(tData);
	 ...
	 * @param tData
	 */
	public void insertAtEnd(float tData){
	...
	public void removeAtBeginning(){
		...
		DoublyNodeFloat tmp = head.getNext();
	 ...
	 * @param tdata
	 */
	public void dataToList(float tdata){
