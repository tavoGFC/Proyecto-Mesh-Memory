...
public class DoublyLinkedListInt {
	...
	private DoublyNodeInt head = null; //null node for the head of the list
	private DoublyNodeInt tail = null; //null node for the tail of the list
	private String id;
	 ...
	 * @param pData
	 */
	public void insertAtBeginning(int tData){
		
		DoublyNodeInt data = new DoublyNodeInt(tData);
	 ...
	 * @param tData
	 */
	public void insertAtEnd(int tData){
	...
	public void removeAtBeginning(){
		...
		DoublyNodeInt tmp = head.getNext();
	 ...
	 * @param tdata
	 */
	public void dataToList(int tdata){
