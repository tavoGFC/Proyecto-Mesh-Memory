...
public class DoublyLinkedListChar {
	...
	private DoublyNodeChar head = null; //null node for the head of the list
	private DoublyNodeChar tail = null; //null node for the tail of the list
	private String id;
	 ...
	 * @param pData
	 */
	public void insertAtBeginning(char tData){
		
		DoublyNodeChar data = new DoublyNodeChar(tData);
	 ...
	 * @param tData
	 */
	public void insertAtEnd(char tData){
	...
	public void removeAtBeginning(){
		...
		DoublyNodeChar tmp = head.getNext();
	 ...
	 * @param tdata
	 */
	public void dataToList(char tdata){
