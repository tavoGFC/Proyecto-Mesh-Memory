...
public class DoublyLinkedListDouble {
	
	private DoublyNodeDouble head = null; //null node for the head of the list
	private DoublyNodeDouble tail = null; //null node for the tail of the list
	private String id;
	 ...
	 * @param pData
	 */
	public void insertAtBeginning(double tData){
		
		DoublyNodeDouble data = new DoublyNodeDouble(tData);
	 ...
	 * @param tData
	 */
	public void insertAtEnd(double tData){
	...
	public void removeAtBeginning(){
		...
		DoublyNodeDouble tmp = head.getNext();
	 ...
	 * @param tdata
	 */
	public void dataToList(double tdata){
